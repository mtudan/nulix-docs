        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                html: `
                <a href="https://github.com/mtudan" target="_blank" aria-label="GitHub repository" rel="noopener noreferrer" style="display:block;width:24px;height:24px;border-radius:100%;">
